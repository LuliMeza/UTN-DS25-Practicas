...
const Ciencia = () => {
  ...
  if (cargando) return <p className="text-center mt-5">Cargando libros de ciencia...</p>;

  // Filtrar solo libros de ciencia
        ...
        <Row className="mb-3">
          <Col>
            <p className="text-muted text-center">
              {librosFiltrados.length} libro{librosFiltrados.length !== 1 ? 's' : ''} de ciencia
            ...
            <Card className="shadow-sm hover-lift">
              ...
              />
                <Card.Body className="text-center d-flex flex-column">
                  <Card.Title className="h5">{libro.title}</Card.Title>
          ...
          <Row className="mt-5">
            <Col className="text-center">
              ...
              <p className="text-muted">
                {terminoBusqueda 
                  ? `No hay libros de ciencia que coincidan con "${terminoBusqueda}"`
                  : 'No hay libros de ciencia disponibles'
                }
              </p>
              {terminoBusqueda && (
